...
// Machine
#define MACHINEID 3                // see above list of supported machines
...
#define OTAHOST "quickmill-coffee"           // Name to be shown in Arduino IDE/PlatformIO port
...
#define BREWPID_DELAY 1           // delay until enabling PID controller during brew (no heating during this time)
#define TEMPSENSOR 1               // Temp sensor type: 1 = DS18B20, 2 = TSIC306
